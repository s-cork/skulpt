                ...
                if (group_key === "y") {
                    ...
                    if (z === "Z") {
                        ...
                        if (z[3] === ":") {
                            ...
                            if (z.length > 5) {
                                if (z[5] !== ":") {
                                    msg = `Inconsistent use of : in ${found_dict["z"]}`;
                                    throw new ValueError(msg);
                                }
                                z = z.slice(0, 5) + z.slice(6);
                            }
                        }
                        hours = _as_integer(z.slice(1, 3));
                        minutes = _as_integer(z.slice(3, 5));
                        seconds = _as_integer(z.slice(5, 7) || 0);
