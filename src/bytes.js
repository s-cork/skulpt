...
function Uint8ArrayFromBinString(source) {
    let cc;
    const uarr = new Uint8Array(source.length);
    for (let i in source) {
...
function Uint8ArrayFromIterable(pySource, initial) {
    const source = initial || [];
    const r = Sk.misceval.iterFor(Sk.abstr.iter(pySource), (byte) => {
        const n = byte_as_num(byte);
        source.push(n);
    });
    return Sk.misceval.chain(r, () => Uint8ArrayFromArray(source));
}
...
Sk.builtin.bytes = function (source, encoding, errors) {
    if (!(this instanceof Sk.builtin.bytes) && !(this instanceof Sk.builtin.bytearray)) {
        // called from python
        return newBytesFromPy.call(Sk.builtin.bytes, ...arguments);
    }
    ...
    if (source === undefined) {
        ...
        this.v = Uint8ArrayFromBinString(source);
        this._$jsstr = source;
    } else if (typeof source === "number") {
        this.v = new Uint8Array(source);
    } else {
        // fall through case for subclassing called by Sk.abstr.superConstructor
        const ret = Sk.misceval.chain(newBytesFromPy.call(this.sk$builtinBase,...arguments), (pyBytes) => {
            this.v = pyBytes.v;
            return this;
        });
...
function newBytesFromPy(pySource, encoding, errors) {
    ...
    if (pySource === undefined) {
        ...
        return new this(pySource.v);
    } else if (this === Sk.builtin.bytes && (dunderBytes = Sk.abstr.lookupSpecial(pySource, Sk.builtin.str.$bytes)) != null) {
        ...
        return Sk.misceval.chain(Uint8ArrayFromIterable(pySource), (source) => new this(source));
    }
    let msg = "";
...
Sk.builtin.bytes.prototype.type$like = function (obj) {
    return obj instanceof Sk.builtin.bytes || obj instanceof Sk.builtin.bytearray;
};
...
Sk.builtin.bytes.prototype.b$repr = function b$repr () {
    let num;
    let quote = "'";
    ...
    return "b" + quote + ret + quote;
};

Sk.builtin.bytes.prototype["$r"] = function () {
    return new Sk.builtin.str(this.b$repr());
};
...
Object.assign(Sk.builtin.bytes.prototype, str_lib);
...
//         return newBytesFromPy.call(Sk.builtin.bytearray, ...arguments);
//     }
//     Sk.builtin.bytes.call(this, ...arguments);
// };

// Sk.abstr.setUpInheritance("bytearray", Sk.builtin.bytearray, Sk.builtin.object);

// Object.assign(Sk.builtin.bytearray.prototype, Sk.builtin.bytes.prototype);
// Sk.builtin.bytearray.prototype.sk$builtinBase = Sk.builtin.bytearray;
// Sk.builtin.bytearray.prototype.__class__ = Sk.builtin.bytearray;
// Sk.builtin.bytearray.prototype.$r = function () {
//     return new Sk.builtin.str("bytearray(" + this.b$repr() + ")");
// };

// Sk.builtin.bytearray.prototype.nb$inplace_add = function (other) {
//     if (!this.type$like(other)) {
//         throw new Sk.builtin.TypeError("can't concat "+ Sk.abstr.typeName(other) +" to " + Sk.abstr.typeName(this));
//     }
//     let arr = new Array.from(this.v);
//     arr.push(...other.v);
//     this.v = Uint8ArrayFromArray(arr);
//     this._$jsstr = undefined;
//     return this;
// };

// Sk.builtin.bytearray.prototype.extend = new Sk.builtin.func(function (self, iterable) {
//     Sk.builtin.pyCheckArgsLen("extend", arguments.length, 2, 2);
//     return Sk.misceval.chain(Uint8ArrayFromIterable(iterable, Array.from(self.v)), (uarr) => {
//         self.v = uarr;
//         self._$jsstr = undefined;
//         return Sk.builtin.none.none$;
//     });
// });


// Sk.builtin.bytearray.prototype.append = new Sk.builtin.func(function (self, byte) {
//     Sk.builtin.pyCheckArgsLen("extend", arguments.length, 2, 2);
//     const n = byte_as_num(byte);
//     const newUarr = new Uint8Array(self.v.length + 1);
//     newUarr.set(self.v, 0);
//     newUarr.set([n], self.v.length);
//     self.v = newUarr;
//     self._$jsstr = undefined;
//     return Sk.builtin.none.none$;
// });

// Sk.builtin.bytearraye.prototype.remove = new Sk.builtin.func(function(self, byte) {
//     Sk.builtin.pyCheckArgsLen("remove", arguments.length, 2, 2);
//     const n = byte_as_num(byte);

//     arr.push(n); 
//     self.v = Uint8ArrayFromArray(arr);
//     self._$jsstr = undefined;
//     return Sk.builtin.none.none$;
// });